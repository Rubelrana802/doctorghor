		...
		<div class="card-body">
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Login</div>
		    <form method="POST" action="{{ route('company.login.submit') }}" aria-label="{{ __('company.login.submit') }}">
                        @csrf
			  ...
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  ...
				  <input id="password" type="password" class="form-control form-control-rounded{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="Enter your password">
			...
			<div class="form-row mr-0 ml-0">
			 ...
			 <div class="form-group col-6 text-right">
			  <a href="{{ route('company.password.request') }}">Reset Password</a>
			 </div>
			</div>
			  ...
			  <div class="text-center pt-3">
				<hr>
				<p class="text-muted">Do not have an account? <a href="{{ url('/company/register')}}"> Sign Up here</a></p>
			  </div>
			 </form>
		   </div>
		  </div>
