		...
		<div class="card-body">
		 <div class="card-content p-2">
		 	<div class="text-center">
		 		<img src="{{ asset('public/admin') }}/assets/images/companylogo.png">
		 	</div>
		    ...
		    <form method="POST" action="{{ route('company.register.submit') }}" aria-label="{{ __('Register') }}">
			  ...
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  ...
				  <input id="name" type="text" class="form-control form-control-rounded{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Company name" name="name" value="{{ old('name') }}" required autofocus>
			  ...
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  <label for="Reference_Code" class="sr-only">{{ __('Reference_Code') }}</label>
				  <input id="Reference_Code" type="Reference_Code" class="form-control form-control-rounded{{ $errors->has('Reference_Code') ? ' is-invalid' : '' }}" placeholder="Reference code" name="Reference_Code" value="{{ old('Reference_Code') }}" required>
			  ...
			  <div class="text-center pt-3">
				<hr>
				<p class="text-muted">Already have an account? <a href="{{ route('company.login') }}"> Login In here</a></p>
			  </div>
			 </form>
		   </div>
		  </div>
