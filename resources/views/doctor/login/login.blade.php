        ...
        <div class="card-body">
         <div class="card-content p-2">
          ...
          <div class="card-title text-uppercase text-center py-3">Login</div>
            <form method="POST" action="{{ route('Doctor.login') }}" aria-label="{{ __('Doctor.login.submit') }}">
                        @csrf
            ...
            <div class="form-row mr-0 ml-0">
             ...
             <div class="form-group col-6 text-right">
              ...
              <div class="text-center pt-3">
                <hr>
                <p class="text-muted">Do not have an account? <a href="{{ route('Doctor.register') }}"> Sign Up here</a></p>
              </div>
             </form>
           </div>
          </div>
