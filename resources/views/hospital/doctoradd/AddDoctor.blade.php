...
<div class="row">
            <div class="col-sm-12">
                <div class="column">
                    <a href="{{ url('/doctor/manage') }}" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Manage Doctor </a>
                </div>
            </div>
        </div>
        <br />
			     ...
			     <div class="card-body">
				   ...
				   <hr>				   
					...
					<div class="form-group row">
					  <label for="input-1" class="col-sm-2 col-form-label">Hospital Name :</label>
					  <div class="col-sm-6">
						<select name="hospitals" id="hospitals" class="form-control" selected="true" readonly>
							<option value="{{ Auth::guard('hospital')->user()->id }}">{{ Auth::guard('hospital')->user()->name }}</option>
						</select>
					  </div>
					</div>
					<div class="form-group row">
					  <label for="input-2" class="col-sm-2 col-form-label">Department :<i class="text-danger">*</i></label>
					  <div class="col-sm-6">
						<select name="departments" id="departments" class="form-control" selected="true" required>
