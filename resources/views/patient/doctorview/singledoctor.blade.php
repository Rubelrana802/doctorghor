    ...
    <div class="row text-center pt-4 pt-md-5">
      ...
      <div class="col-12 col-sm-10 col-md-6 col-lg-4 ml-sm-auto mr-sm-auto mt-5 mt-md-0">
        <p class="appointment">Doctor's Appointment at</p>
                ...
                <form role="form" method="post" action="{{ url('/patient/appointment') }}">
                        {{csrf_field()}}            
                    ...
                    <input type="hidden" name="doctor_id" value="{{ $doctor->id }}"> 
                     <div class="form-group row">
                      ...
                      <div class="col-sm-12">
                        <button type="submit" id="submit" class="btn btn-info btn-block shadow-info px-5"> Get Appointment</button>
                      </div>
                    </div>
                </form>
      </div>
