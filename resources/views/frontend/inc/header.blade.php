<header>
  ...
  <div class="col-lg-2 col-md-12">
                        <a id="logo" href="{{ url('/' )}}" class="d-inline-block margin-tb-15px"><img src="{{ asset('public/frontend') }}/assets/img/doctor.png" alt=""></a>
                    ...
                    <div class="col-lg-3 col-md-12">
                        ...
                        <a href="{{ url('/dctr/login') }}" class="margin-tb-20px d-inline-block text-up-small float-left float-lg-right" style="color: #DA2138; font-weight: bold;"><i class="fa fa-user"></i>  Doctor Login</a>
                    </div>
                </nav>
                </div>
            </div>
